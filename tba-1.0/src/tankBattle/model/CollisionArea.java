...
/**
 * Questa classe rappresenta il corpo di ogni componente.
 * 
 * Con l'istanza di questa classe &egrave; possibile verificare se ci sono state
 * collisioni.
 * 
...
public final class CollisionArea {
	 ...
	 * 
	 * @param curAngle
	 *            un intero che rappresenta l'indice dell'angolo corrente.
	 */
