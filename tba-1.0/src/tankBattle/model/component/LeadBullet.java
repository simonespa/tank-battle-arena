...
/**
 * Le istanze di questa classe rappresentano il proiettile di piombo che viene
 * sparato dal tank durante la sessione di gioco.
 * 
...
public final class LeadBullet extends Bullet implements Runnable {
	...
	public LeadBullet(String id, double x, double y, double angle,
			TankBulletView view) {
