...
/**
 * &Egrave; la barra dei menù della finestra principale.
 * 
...
public final class MainMenuBar extends JMenuBar {
	...
	/**
	 * Crea una menu bar parametrizzata. Contiene gi&agrave; le voci di
	 * men&ugrave; ed i sotto men&ugrave;
	 * 
	 * @param controller
	...
	/**
	 * Inizializza tutti i men&ugrave;
	 */
	private void initMenu() {
		...
		debugMode = new JMenu("Debug mode");
		debug = new JCheckBoxMenuItem();
		if (TankBattleGame.isDebugMode()) {
	...
	private void setIconMenu() {
		...
		/* option menu */
		debugMode.setIcon(r.getGUIWindowedImage("newGame"));
