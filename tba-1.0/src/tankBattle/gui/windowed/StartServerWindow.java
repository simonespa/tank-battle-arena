...
/**
 * E' la finestra da cui è possibile gestire e far partire il server.
 * 
 * @author Simone Spaccarotella
 */
public final class StartServerWindow extends JFrame {

	private StartServerPanel panel;
	 ...
	 */
	public StartServerWindow(MainWindow frame, GUIWindowedController controller) {
		...
		panel = new StartServerPanel(controller);
