...
/**
 * Il pannello del client, dal quale &egrave; possibile cercare un server ed
 * agganciarsi.
 * 
...
public final class JoinServerPanel extends JSplitPane {
	...
	/**
	 * Crea un nuovo pannello, passando il riferimento del controller.
	 * 
	 * @param controller
	...
	/**
	 * Imposta il divider del pannello.
	 */
	...
	/**
	 * Aggiunge una nuova riga, nella tabella presente in questo pannello.
	 * 
	 * @param server
	 *            il nome del server.
	 * @param ip
	...
	/**
	 * Rimuove tutte le righe della tabella contenuta nel server.
	 */
	 ...
	 * 
	 * @param owner
	 *            il nome di chi stampa il messaggio.
	 * @param message
