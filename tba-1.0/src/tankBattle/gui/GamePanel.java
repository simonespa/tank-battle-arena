...
public final class GamePanel extends JPanel {
	...
	/**
	 * Inizializza il pannello di gioco, settando il ground e la mappa.
	 */
	private void initGamePanel() {
		...
		// istanzia il ridisegnatore
		repainter = new Repainter(rootView);
		repainter.start();
		// setta il constraint
		GridBagConstraints constraints = new GridBagConstraints();
		constraints.fill = GridBagConstraints.BOTH;
		...
		// fa partire il ridisegnatore
	}

	/**
	 * Aggiunge un nuovo tank al gioco.
	 * 
	 * @param tank
	 *            il tank da aggiungere.
	 */
	...
	/**
	 * Rimuove il tank specificato in input, dal gioco.
	 * 
	 * @param tank
	 *            il tank da rimuovere.
	 */
