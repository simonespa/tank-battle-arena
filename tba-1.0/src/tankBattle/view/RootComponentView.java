...
/**
 * Questa classe rappresenta il nodo principale della view. Ad esso vengono
 * agganciate tutte le viste di tutti i componenti principali. E' un pannello a
 * layer il quale permette la sovrapposizione in trasparenza di tutte le view.
 * Ogni view ha un livello assegnato ed interagisce con gli altri
 * indipendentemente dal livello occupato. La differenza di livello ha influenza
 * solo sulla visualizzazione dei componenti e non sull'interazione dei
 * componenti dal punto di vista delle collisioni.
 * 
...
public final class RootComponentView extends JLayeredPane {
	...
	/** il numero di tank presenti nel gioco */
	 ...
	 * 
	 * @return un intero che rappresenta il numero dei tank presenti nella
	 *         scena.
	 */
	 ...
	 */
	public void update() {
		Set<Tank> tanks = tankMap.keySet();
		for (Tank t : tanks) {
			tankMap.get(t).update();
		}
	}
}