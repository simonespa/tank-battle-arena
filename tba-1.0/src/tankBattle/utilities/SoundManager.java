...
public final class SoundManager implements LocalSoundLoadable {
	...
	/**
	 * Parte la musica di gioco in base alle impostazioni di sistema.
	 */
	...
	/**
	 * L'audio di quando il gioco va in pausa.
	 */
	public void pause() {
		pause = true;
		if (TankBattleGame.getMusicState() == ON) {
	...
	/**
	 * Reimposta i parametri per ritornare in gioco.
	 */
	...
	/**
	 * Quando si ritorna nel menu principale.
	 */
	...
	/**
	 * Riproduce il rumore del proiettile quando esplode contro il tank.
	 */
	...
	/**
	 * Riproduce il rumore del proiettile quando esplode contro un muretto.
	 */
