...
/**
 * Questa classe serve modifica il colore di una qualsiasi immagine passata in
 * input. I suoi metodi ricevono un immagine ed un colore, e restituiscono la
 * stessa immagine con la tonalit&agrave; di colore prescelta.
 * 
...
public final class ColorFilter extends RGBImageFilter {
	...
	/**
	 * Trasforma il colore da RGB (Red-Green-Blue) a HSL
	 ...
	 * @param b
	 *            blue
	 * @return restituisce un array di floating che corrisponde alle 3
	 *         componenti HSL
	 */
	...
	/**
	 * Trasforma il colore da HSL (Hue-Saturation-Lightness) a RGB
	 * (Red-Green-Blue).
	 * 
	 * @param f
	 * @param f1
