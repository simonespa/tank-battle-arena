 ...
 * 
 * Questo pannello contiene al suo interno due pannelli: uno per la visualizzazione
 * dello stato del tank, e l'altro nel quale è possibile scrivere dei messaggi
 * da recapitare a tutti i componenti presenti nel gioco.
 * 
...
public final class GameStatePanel extends JPanel {
	...
	/**
	 * Crea il pannello che compare nella parte superiore della finestra di gioco.
	 */
