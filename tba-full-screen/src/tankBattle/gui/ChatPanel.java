...
public class ChatPanel extends JPanel {
	 ...
	 * 
	 * @param guiController il controller della GUI.
	 */
	...
	public String flush() {
		...
		console.append("IO: " + sender.getText() + System.getProperty("line.separator"));
		sender.setText("");
	...
	public void printConsole(String message) {
		...
		console.append(split[1] + ": " + split[2] + System.getProperty("line.separator"));		
	}
