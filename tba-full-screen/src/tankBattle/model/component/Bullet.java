 ...
 * armato un Tank. Questa classe puï¿½ essere estesa ed ampliata per poter creare
 * un nuovo tipo di proiettile, personalizzato.
 * 
...
public abstract class Bullet extends GameComponent implements Runnable {
	 ...
	 * Crea un proiettile.
	 * 
	 * @param pow il potere distruttivo dell proiettile.
	 */
	...
	/**
	 * Setta il riferimento alla torretta dalla quale il proiettile viene esploso.
	 * 
	 * @param turret il riferimento al componente {@code Turret}.
	 */
