...
/**
 * L'istanza di questa classe rappresenta il componente "Turret". Questo componente ï¿½
 * la torretta del "Tank", la quale puï¿½ roteare su se stessa e sparare i proiettili.
 * 
 * @author Simone Spaccarotella
 * 
 */
public final class Turret extends ColoredComponent implements Serializable, Revolving {
	...
	/**
	 * Istanzia una torretta con una posizione centrale rispetto al Tank e con lo
	 * stesso colore.
	 * 
	 * @param x l'ascissa della posizione centrale rispetto al Tank.
	 * @param y l'ordinata della posizione centrale rispetto al Tank.
	 * @param color il colore del tank.
	 */
	 ...
	 * 
	 * @param currentAngle un intero che corrisponde al i-esimo spiazzamento della torretta.
	 */
